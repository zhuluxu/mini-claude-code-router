...
import type { ChatCompletionRunner, ChatCompletionToolRunnerParams } from "./ChatCompletionRunner.mjs";
import type { ChatCompletionStreamingRunner, ChatCompletionStreamingToolRunnerParams } from "./ChatCompletionStreamingRunner.mjs";
...
export declare class AbstractChatCompletionRunner<EventTypes extends AbstractChatCompletionRunnerEvents, ParsedT> extends EventStream<EventTypes> {
    ...
    protected _runTools<FunctionsArgs extends BaseFunctionsArgs>(client: OpenAI, params: ChatCompletionToolRunnerParams<FunctionsArgs> | ChatCompletionStreamingToolRunnerParams<FunctionsArgs>, runner: ChatCompletionRunner<any> | ChatCompletionStreamingRunner<any>, options?: RunnerOptions): Promise<void>;
}
